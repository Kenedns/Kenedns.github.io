	...
	if(!valid) {
		...
		<body background="images/bg.jpg">
			...
			?>
				...
				<td width="70%">Зробити сайт з нами легко
...
<p><img src="images/penzil.jpg" height="140" width="140" align="left" hspace="15" vspace="5">
...
<p>Звертайтесь до веб-студії Web-DECO, і ми з радістю застосуємо свої здібності і досвід для вирішення Ваших задач! Ми можемо створити сайт, який стане для Вас вдалою інвестицією.</p></td>
			</tr>
			<tr>
				<td background="images/bg-3.jpg" colspan="2" valign="middle" height="90" > 
				<font size="4">Сайт розробив "Никитюк Станіслав"</font>
				</td>
				</tr>
			</table>
		</body>
